process BWA_INDEX {
    ...
    script:
    def prefix = task.ext.prefix ?: "${fasta.getSimpleName()}"
    ...
    """
    mkdir -p ${prefix}
    touch ${prefix}/${prefix}.amb
    touch ${prefix}/${prefix}.ann
    touch ${prefix}/${prefix}.bwt
    touch ${prefix}/${prefix}.pac
    touch ${prefix}/${prefix}.sa
    """
}
